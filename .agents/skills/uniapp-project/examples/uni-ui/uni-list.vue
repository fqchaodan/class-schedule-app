...
<template>
  <view class="container">
    ...
    <uni-section title="禁用列表" type="line">
      <uni-list>
        <uni-list-item :disabled="true" title="列表禁用状态" right-text="右侧文字" />
        <uni-list-item :disabled="true" title="列表禁用状态" right-text="右侧文字" />
      </uni-list>
    </uni-section>
    ...
    <uni-section title="显示右侧箭头" type="line">
      <uni-list>
        <uni-list-item show-arrow title="列表文字" />
        <uni-list-item show-arrow title="列表文字" right-text="右侧文字" />
      </uni-list>
    </uni-section>
    ...
    <uni-section title="开启点击反馈" type="line">
      <uni-list>
        ...
        <uni-list-item title="关闭当前页面打开新页面" show-arrow link="redirectTo" to="./chat" @click="onClick" />
        <uni-list-item title="打开错误页面(查看控制台)" show-arrow link="redirectTo" to="./chats" @click="onClick" />
      </uni-list>
    </uni-section>
    ...
    <uni-section title="不显示分隔线" type="line">
      <uni-list :border="false">
        <uni-list-item title="列表文字" />
        <uni-list-item :border="false" title="列表文字" note="列表描述信息" right-text="右侧文字" />
        <uni-list-item :border="false" title="列表文字" note="列表描述信息" right-text="右侧文字" />
      </uni-list>
    </uni-section>
    ...
    <uni-section title="文字溢出隐藏" type="line">
      <uni-list>
        ...
        <uni-list-item ellipsis="2" title="超长文字显示二行,以下是测试文字以下是测试文字以下是测试文字以下是测试文字以下是测试文字以下是测试文字" right-text="二行显示" />
        <uni-list-item ellipsis="1" title="全部显示,以下是测试文字以下是测试文字以下是测试文字以下是测试文字以下是测试文字以下是测试文字" note="列表描述信息,下是测试文字,下是测试文字,下是测试文字,下是测试文字,下是测试文字,下是测试文字,下是测试文字" show-arrow right-text="一行显示" />
        <uni-list-item title="全部显示,以下是测试文字以下是测试文字以下是测试文字以下是测试文字以下是测试文字以下是测试文字" show-arrow right-text="全部" />
      </uni-list>
    </uni-section>

    <uni-section title="显示图标或图片" type="line">
      <uni-list>
        <uni-list-item :show-extra-icon="true" show-arrow :extra-icon="extraIcon" title="列表左侧带扩展图标" />
        <uni-list-item title="列表左侧带略缩图" note="列表描述信息" show-arrow thumb="https://qiniu-web-assets.dcloud.net.cn/unidoc/zh/unicloudlogo.png" thumb-size="sm" right-text="小图" />
        <uni-list-item title="列表左侧带略缩图" note="列表描述信息" show-arrow thumb="https://qiniu-web-assets.dcloud.net.cn/unidoc/zh/unicloudlogo.png" thumb-size="base" right-text="默认" />
        <uni-list-item title="列表左侧带略缩图" note="列表描述信息" show-arrow thumb="https://qiniu-web-assets.dcloud.net.cn/unidoc/zh/unicloudlogo.png" thumb-size="lg" right-text="大图" />
      </uni-list>
    </uni-section>
