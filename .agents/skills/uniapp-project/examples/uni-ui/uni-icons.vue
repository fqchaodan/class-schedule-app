  ...
  <view class="container">
    ...
    <uni-section title="不同大小" type="line" padding>
      <view class="example-body">
        ...
        <uni-icons type="contact" size="30" />
        <uni-icons type="contact" size="40" />
      </view>
    </uni-section>
    ...
    <uni-section title="不同颜色" type="line" padding>
      <view class="example-body">
        <uni-icons type="contact" size="30" color="#007aff" />
        <uni-icons type="contact" size="30" color="#ff3b30" />
        <uni-icons type="contact" size="30" color="#ffcc00" />
        <uni-icons type="contact" size="30" color="#4cd964" />
      </view>
    </uni-section>
    ...
    <uni-section title="常用图标" type="line" padding>
      <view class="icon-grid">
        <view v-for="(icon, index) in commonIcons" :key="index" class="icon-item">
          <uni-icons :type="icon" size="30" color="#333" />
